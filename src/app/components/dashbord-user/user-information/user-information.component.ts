...
export class UserInformationComponent implements OnInit {
  ...
  async getCurrentUser() {
    ...
    //Traitement spécifique quand l'utilisateur n'a pas encore d'adresse (premiére connexion)
    ...
    if (this.userDetailsResponseModel.userAddress.addressCity == null) {
      this.userDetailsResponseModel.userAddress.addressCity = new CityDtoModel(
        0,
        '',
        '',
